                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <section id="description">
                                <h2>Description</h2>
                                <p>
A machine learning course teaches the principles and techniques for creating algorithms that enable computers to learn from data. Students learn to develop models for predictions and decisions without explicit programming. Topics include data handling, model training, and real-world applications.</p>
                            </section>
                            <!-- /section -->
                                    ...
                                    <div class="card">
                                        <div class="card-header" role="tab" id="headingTwo">
                                            <h5 class="mb-0">
                                                ...
                                                <i class="fa-solid fa-plus"></i> Generative Modeling Review
                                                </a>
                                            </h5>
                                        </div>
                                            ...
                                            <div class="card-body">
                                                <div class="list_lessons">
                                                    <ul>
                                                        <li><a href="" class="video">Health Science</a><span>00:59</span></li>
                                                        <li><a href="" class="video">Health and Social Care</a><span>00:59</span></li>
                                                        <li><a href="" class="video">History</a><span>00:59</span></li>
                                                        <li><a href="" class="video">Healthcare Science</a><span>00:59</span></li>
                                                        <li><a href="#0" class="txt_doc">Audiology</a><span>00:59</span></li>
                                                    </ul>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card">
                                        <div class="card-header" role="tab" id="headingThree">
                                            <h5 class="mb-0">
                                                ...
                                                <i class="fa-solid fa-plus"></i> Variational Autoencoders
                                                </a>
                                            </h5>
                                        </div>
                                    ...
                                    <div class="card">
                                        <div class="card-header" role="tab" id="headingFourth">
                                            <h5 class="mb-0">
                                                ...
                                                <i class="fa-solid fa-plus"></i> Gaussian Mixture Model Review
                                                </a>
                                            </h5>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3">
                                            <div id="review_summary">
                                                <strong>4.7</strong>
                                                <div class="rating">
                                                <i class="fa-solid fa-star"></i></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i>
                                                </div>
                        ...
                        <aside class="col-lg-4" id="sidebar">
                            <div class="box_detail">
                                <figure>
                                    <a href="" class="video"><i class="arrow_triangle-right"></i><img src="../courses/images/machine learning.jpg" alt="machine learning" class="img-fluid"></a>
                                </figure>
