...
let addDepartmentBtn = document.getElementById("addDepartment");

addDepartmentBtn.onclick = () => {
  Swal.fire({
    title: "Add a department",
    html: `<form class="videoForm">
          <input id="department-input" class="swal2-input" placeholder="Department name" required>
          <label for="mainPic-input" class="custom-file-input" style="display:block">
            Choose Main picture
            <input id="mainPic-input" type="file" class="hidden" required>
        </label>
          <label for="coverPic-input" class="custom-file-input" style="display:block">
            Choose Cover picture
            <input id="coverPic-input" type="file" class="hidden" required>
        </label>
